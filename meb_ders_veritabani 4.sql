...
INSERT OR IGNORE INTO temel_plan_alan (alan_adi) VALUES ('SAĞLIK HİZMETLERİ');
INSERT OR IGNORE INTO temel_plan_dal (dal_adi, alan_id) SELECT 'HEMŞİRE YARDIMCILIĞI', id FROM temel_plan_alan WHERE alan_adi = 'SAĞLIK HİZMETLERİ';
...
INSERT OR IGNORE INTO temel_plan_ders_dal (ders_id, dal_id) SELECT (SELECT id FROM temel_plan_ders WHERE ders_adi = 'ANATOMİ VE FİZYOLOJİ'), (SELECT id FROM temel_plan_dal WHERE dal_adi = 'HEMŞİRE YARDIMCILIĞI');
